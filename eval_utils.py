...
os.environ["IMAGEIO_FFMPEG_LOGLEVEL"] = "error"  # or "quiet"
...
def stitch_videos(video_dir, eval_episode):
    ...
    final_clip.write_videofile(video_dir + "/" + str(eval_episode) + "_stitched_op.mp4", codec="libx264", logger = None)
...
def eval_agent(
    ...
    episode_rewards = []
    print()
    progress_bar = tqdm(range(num_episodes), desc="Eval")
